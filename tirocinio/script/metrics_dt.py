"""
    Questo script legge le metriche dei modelli di albero di decisione da file di log, le organizza in un formato tabellare 
...
def main():
    ...
    paths = [
        '../logs/dt_original_data_smotenc.log',
        '../logs/dt_original_data_autoencoder.log',
        '../logs/dt_dummy_data_smotenc.log',
        '../logs/dt_dummy_data_autoencoder.log',
        '../logs/dt_pca_data_smotenc.log',
        '../logs/dt_pca_data_autoencoder.log'
    ]
