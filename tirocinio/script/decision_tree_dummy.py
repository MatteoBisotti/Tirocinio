"""
    Questo script carica il dataset con one hot encoding. Applica un modello di albero di decisione, eseguendo un metodo di holdout sui dati per la 
...
file_handler = logging.FileHandler('../logs/dt_dummy_data.log')
