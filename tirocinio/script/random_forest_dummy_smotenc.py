"""
    Questo script carica il dataset con one hot encoding, applica oversampling tramite l'algoritmo SMOTENC.
...
file_handler = logging.FileHandler('../logs/rf_dummy_data_smotenc.log')
