"""
    Questo script carica il dataset con pca, applica oversampling tramite autoencoder.
...
file_handler = logging.FileHandler('../logs/rf_pca_data_autoencoder.log')
...
def main():
    ...
    model = RandomForestGscvModel(param_grid=param_grid, cv=5, scoring='f1_macro')
