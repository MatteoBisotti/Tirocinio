"""
    Questo script carica il dataset con one hot encoding, applica oversampling tramite SMOTENC.
...
file_handler = logging.FileHandler('../logs/dt_dummy_data_smotenc.log')
