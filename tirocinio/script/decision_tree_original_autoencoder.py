"""
    Questo script carica il dataset originale, applica oversampling tramite un autoencoder.
...
file_handler = logging.FileHandler('../logs/dt_original_data_autoencoder.log')
