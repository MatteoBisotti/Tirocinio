"""
    Questo script carica il dataset originale con one hot encoding e applica oversampling tramite un autoencoder 
...
dataset_augmented.to_csv("../csv/dataset_dummy_autoencoder.csv")